...
import { FiFilm, FiMail, FiPhone, FiMapPin } from 'react-icons/fi';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <FiFilm className="h-8 w-8 text-primary-400" />
              <span className="ml-2 text-xl font-bold">MovieBook</span>
            </div>
            <p className="text-gray-400 mb-4">
              Your premier destination for booking movie tickets online.
              Experience the magic of cinema with our seamless booking system.
            </p>
